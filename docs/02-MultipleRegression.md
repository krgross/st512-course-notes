...
The code below shows an example of the second approach, in which we create a new predictor using PCA that is the composite of nicotine and tar.  Then we use this composite predictor as the (in this case, lone) predictor in a regression model.


``` r
pca <- prcomp(cig[, c("tar", "nicotine")],
              center = TRUE,
              scale. = TRUE)

# Make PC1 increase as tar and nicotine increase.
# With two positively associated variables, the two loadings
# should have the same sign; reverse PC1 if that sign is negative.
...
## 
## Call:
## lm(formula = cig$co ~ PC1)
## 
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -3.3937 -0.9715  0.3190  0.8864  3.0104 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  12.5280     0.3103   40.38  < 2e-16 ***
## PC1           3.1935     0.2252   14.18 7.41e-13 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 1.551 on 23 degrees of freedom
## Multiple R-squared:  0.8973,	Adjusted R-squared:  0.8929 
## F-statistic:   201 on 1 and 23 DF,  p-value: 7.409e-13
```

The plot below shows the composite predictor overlaid on a scatterplot of nicotine and tar (left), as well as the simple regression model that results on the right.

<img src="02-MultipleRegression_files/figure-html/unnamed-chunk-31-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="02-MultipleRegression_files/figure-html/unnamed-chunk-36-1.png" width="480" style="display: block; margin: auto;" /><img src="02-MultipleRegression_files/figure-html/unnamed-chunk-36-2.png" width="480" style="display: block; margin: auto;" /><img src="02-MultipleRegression_files/figure-html/unnamed-chunk-36-3.png" width="480" style="display: block; margin: auto;" /><img src="02-MultipleRegression_files/figure-html/unnamed-chunk-36-4.png" width="480" style="display: block; margin: auto;" />
